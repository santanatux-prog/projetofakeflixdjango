...
ALLOWED_HOSTS = ["projetofakeflixdjango-production.up.railway.app", "localhost", "127.0.0.1"]
...
DATABASE_URL = 'postgresql://postgres:AQdzWVqsEuSWqUyaywquUVAlcBRwNqXk@postgres.railway.internal:5432/railway'
if DATABASE_URL:
    DATABASES = {
